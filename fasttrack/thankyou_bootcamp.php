...
<div class="row contactbx">
   ...
   <div class="container text-center mt50">
           ...
           <h3 style="margin-top:0px;"> <?php echo ($price=="")?
             "<a href='https://besingularonlineprograms.com/international/bootcamp.html'>Register your slot here</a>": "<h3 style='margin-top:0px;'>Pay via Paypal to enroll in BeSingular Bootcamp </h3><h3 style='margin-top:0px;'>Proceed to Pay $".$price." </h3>";
             ?> </h3><br>

           

           <script
    src="https://www.paypal.com/sdk/js?client-id=AZ6EqEy75HI4UPbqhuO09OlvRoAR8H0NMseobXm0Fw8r4LkMO-P2PVNjD98CxVWnqXSY5PsJqnav3hUf"> // Required. Replace SB_CLIENT_ID with your sandbox client ID.
  </script>
