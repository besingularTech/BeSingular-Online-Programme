...
<p style="text-align: left; line-height: 1.8; word-break: break-word; font-family: Montserrat, Tahoma, sans-serif; font-size: 18px; mso-line-height-alt: 32px; margin: 0;"><span style="font-size: 18px;">Dear <strong>'.$parentName.'</strong>,</span></p>
<p style="text-align: left; line-height: 1.8; word-break: break-word; font-family: Montserrat, Tahoma, sans-serif; mso-line-height-alt: 25px; margin: 0;"><strong><span style="font-size: 18px; color: #993366;">Thank you for booking a demo session with us !</span></strong></p>
<p style="text-align: left; line-height: 1.8; word-break: break-word; font-family: Montserrat, Tahoma, sans-serif; font-size: 18px; mso-line-height-alt: 32px; margin: 0;"><span style="font-size: 18px;">Kindly find the session details below:</span></p>
<p style="text-align: left; line-height: 1.8; word-break: break-word; font-family: Montserrat,  Tahoma, sans-serif; mso-line-height-alt: 25px; margin: 0;"> </p>
<p style="text-align: left; line-height: 1.8; word-break: break-word; font-family: Montserrat, Tahoma, sans-serif; mso-line-height-alt: 25px; margin: 0;"><strong><span style="font-size: 18px;">Date and Time - '.'<span style="color:#993366">'.$date.' at '.$time.'</span>'.'<br/>Meeting Link - <span style="color: #993366;"><a href="https://bit.ly/2NaXJUO" rel="noopener" style="text-decoration: underline; color: #993366;" target="_blank">Click Here</a></span><br/>Password- <span style="color: #993366;">BeSingular</span><br/>Session Requirements – <span style="color: #993366;">Laptop/Mobile Phone; Strong Internet Connection</span></span></strong></p>
<p style="font-size: 20px; line-height: 1.8; font-family: Montserrat,  Tahoma, sans-serif; word-break: break-word; mso-line-height-alt: 36px; margin: 0;"><span style="color: #333333; font-size: 20px;"><strong>About Us</strong></span></p>
<p style="font-size: 14px; line-height: 1.8; font-family: Montserrat,  Tahoma, sans-serif; word-break: break-word; mso-line-height-alt: 25px; margin: 0;"><br/><span style="font-size: 18px;">BeSingular is a leading <span style="color: #993366;"><strong>EdTech platform</strong></span> that delivers moonshot learning to young students by equipping them with future fluencies, exponential technologies and pivotal values.</span><br/><span style="font-size: 18px;">Programmes taught at BeSingular include: <strong><span style="color: #993366;">Artificial Intelligence (AI), Robotics, Game Design, Internet of Things (IoT), 3D printing, iOS App Development and Augmented &amp; Virtual Reality (AR/VR)</span></strong>.</span></p>
<p style="font-size: 18px; line-height: 1.8; font-family: Montserrat,  Tahoma, sans-serif; word-break: break-word; mso-line-height-alt: 32px; margin: 0;"><span style="font-size: 18px;">We look forward to seeing you at the session!</span></p>
<p style="line-height: 1.8; font-family: Montserrat,  Tahoma, sans-serif; word-break: break-word; font-size: 18px; mso-line-height-alt: 32px; margin: 0;"><span style="font-size: 18px;">Best Regards,</span><br/><strong><span style="font-size: 18px; color: #993366;">Team BeSingular</span></strong></p>
</div>
</div>
...
$mail->Host = 'besingular.com';  // Specify main and backup SMTP servers
$mail->SMTPAuth = true;                               // Enable SMTP authentication
$mail->Username = 'crm@besingular.com';                 // SMTP username
$mail->Password = '_*1SIZ~}tXid';                           // SMTP password
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465;                                    // TCP port to connect to
$mail->setFrom('crm@besingular.com');
...
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465;                                    // TCP port to connect to
$mail->setFrom('crm@besingular.com', "BeSingular");
...
$mail->Subject = 'Appointment Booked With BeSingular';
