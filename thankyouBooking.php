...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KFJSZSF"
...
$url = 'https://besingular.zohobookings.in/portal-embed#/customer/besingularbooking?Name='.$name.'&Email='.$email."&Contact=".$contact;
?>
   <iframe width='100%' height='750px' src= "<?php echo $url ?>" frameborder='0' allowfullscreen='' > </iframe>
