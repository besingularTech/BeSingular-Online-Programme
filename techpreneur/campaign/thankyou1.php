...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
  <div class="container">
    ...
    <div class="jumbotron text-center">
        ...
        <p class="lead"><strong>We have recevied your query for further assistance our Tele Counsellor will contact you soon.</strong> </p>
        <hr>
      
        <p class="lead">
          <a class="btn btn-primary btn-sm" href="https://besingular.com/" role="button">Continue to homepage</a>
        </p>
      </div>
